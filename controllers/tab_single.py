...
def table_1_head(workbook, worksheet, row, dbg = False):
    ...
    c = tab_1_head(workbook, worksheet, row, col=c, width=4, arg1=u'Сумма предъяв-ленного штрафа, руб.', arg2=8, widths=col_widths)
    ...
    c = tab_1_head(workbook, worksheet, row, col=c, width=4, arg1=u'Фактически оплаченная сумма, руб.', arg2=10, widths=col_widths)
